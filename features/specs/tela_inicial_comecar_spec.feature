...
Funcionalidade: Tela Inicial - Botão COMEÇAR
	Como usuário da Tela Inicial do aplicativo Training Wheels Protocol em um dispositivo mobile Android 
	Quero clicar no Botão COMEÇAR
