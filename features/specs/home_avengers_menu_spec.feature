...
Funcionalidade: Tela Home AVENGERS - Menu hamburguer
	Como usuário da Tela Home AVENGERS do aplicativo Training Wheels Protocol em um dispositivo mobile Android 
	Quero clicar no menu hamburguer
